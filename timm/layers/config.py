...
__all__ = [
    'is_exportable', 'is_scriptable', 'is_no_jit', 'use_fused_attn', 'set_exportable', 'set_scriptable', 'set_no_jit',
    'set_layer_config', 'set_fused_attn'
]
...
class set_layer_config:
    ...
    """
    def __init__(self, scriptable: Optional[bool] = None, exportable: Optional[bool] = None, no_jit: Optional[bool] = None,
