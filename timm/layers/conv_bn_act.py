...
class ConvNormAct(nn.Module):
    def __init__(
        ...
        self.conv = create_conv2d(in_channels, out_channels, kernel_size, stride=stride, padding=padding, dilation=dilation,
...
class ConvNormActAa(nn.Module):
    def __init__(
        ...
        self.conv = create_conv2d(in_channels, out_channels, kernel_size, stride=1 if use_aa else stride, padding=padding,
